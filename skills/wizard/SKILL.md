...
Run only when the user explicitly asks for a wizard.

## Installed resources

Resolve supporting files relative to the installed directory containing this `SKILL.md`, not the project working directory. In shell examples, set `SKILL_DIR` to that absolute directory and quote it. Keep the working directory in the target project.
